...
DIOconfig configs[DIOpin_NUM] = {
    ...
    {DIOpin_SWITCH_3, GPIOA, {BIT(8), GPIO_Mode_IN, GPIO_Speed_Level_1, GPIO_OType_PP, GPIO_PuPd_NOPULL}},
    {DIOpin_SWITCH_4, GPIOA, {BIT(9), GPIO_Mode_IN, GPIO_Speed_Level_1, GPIO_OType_PP, GPIO_PuPd_NOPULL}},
