...
DIOconfig configs[DIOpin_NUM] = {
    ...
    {DIOpin_RTD_BUTTON, GPIOA, {BIT(6), GPIO_Mode_IN, GPIO_Speed_Level_1, GPIO_OType_PP, GPIO_PuPd_NOPULL}},
    {DIOpin_SWITCH_1, GPIOA, {BIT(7), GPIO_Mode_IN, GPIO_Speed_Level_1, GPIO_OType_PP, GPIO_PuPd_NOPULL}},
    {DIOpin_SWITCH_2, GPIOA, {BIT(8), GPIO_Mode_IN, GPIO_Speed_Level_1, GPIO_OType_PP, GPIO_PuPd_NOPULL}},
