...
void HAL_Can_init(void)
{
    ...
    HAL_Can_init_id_filter_16bit(MAIN_BUS_M170_INTERNAL_STATES_FRAME_ID, MAIN_BUS_PBX_STATUS_FRAME_ID, MAIN_BUS_M192_COMMAND_MESSAGE_FRAME_ID, 0x00); //initializes IDs for filters
